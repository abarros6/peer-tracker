...
-- are_friends helper function (used in RLS policies)
...
-- Invites: allow authenticated users to update (accept) invites
...
-- Friendships: allow inserts for authenticated users
